...
namespace MMRProject.Api.Data.Migrations
{
    ...
    [Migration("20260623081814_AddPushSubscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MMRProject.Api.Data.Entities.V3.NotificationDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "Status", "NextAttemptAt" }, "ix_notification_deliveries_status_next_attempt");
            ...
            modelBuilder.Entity("MMRProject.Api.Data.Entities.V3.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex(new[] { "UserId", "Endpoint" }, "ix_push_subscriptions_user_endpoint")
                        .IsUnique();
            ...
            modelBuilder.Entity("MMRProject.Api.Data.Entities.V3.NotificationDelivery", b =>
                {
                    b.HasOne("MMRProject.Api.Data.Entities.V3.PushSubscription", "Subscription")
                        .WithMany()

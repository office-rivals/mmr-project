...
export class OrganizationsApi extends runtime.BaseAPI {
  ...
  async getOrganization(orgId: string): Promise<OrganizationResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
...
export class OrganizationMembersApi extends runtime.BaseAPI {
  async listMembers(orgId: string): Promise<OrganizationMemberResponse[]> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/members`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
...
export class LeaguesApi extends runtime.BaseAPI {
  async createLeague(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
  ...
  async getLeague(orgId: string, leagueId: string): Promise<LeagueResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
...
export class LeaguePlayersApi extends runtime.BaseAPI {
  async joinLeague(
    orgId: string,
    leagueId: string
  ): Promise<LeaguePlayerResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/players`,
      method: 'POST',
      headers: {},
    });
    return await response.json();
  ...
  async getMe(orgId: string, leagueId: string): Promise<LeaguePlayerResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/players/me`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async getPlayer(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/players/${playerId}`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
...
export class V3SeasonsApi extends runtime.BaseAPI {
  async createSeason(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/seasons`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
  ...
  async getCurrentSeason(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/seasons/current`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
...
export class V3MatchesApi extends runtime.BaseAPI {
  async submitMatch(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/matches`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
...
export class V3LeaderboardApi extends runtime.BaseAPI {
  async getLeaderboard(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/leaderboard`,
      method: 'GET',
      headers: {},
      query,
    });
...
export class V3RatingHistoryApi extends runtime.BaseAPI {
  async getPlayerHistory(
    ...
    if (seasonId) query['seasonId'] = seasonId;
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/rating-history/${leaguePlayerId}`,
      method: 'GET',
      headers: {},
      query,
    });
  ...
  async getLeagueHistory(
    ...
    leagueId: string,
    seasonId?: string
  ): Promise<LeagueRatingHistoryResponse> {
    const query: runtime.HTTPQuery = {};
    if (seasonId) query['seasonId'] = seasonId;
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/rating-history`,
      method: 'GET',
      headers: {},
      query,
    });
...
export class V3QueueApi extends runtime.BaseAPI {
  async joinQueue(orgId: string, leagueId: string): Promise<void> {
    await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/queue`,
      method: 'POST',
      headers: {},
    });
  }
...
export class V3PendingMatchesApi extends runtime.BaseAPI {
  async getPendingMatchStatus(
    orgId: string,
    leagueId: string,
    pendingMatchId: string
  ): Promise<PendingMatchResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/pending-matches/${pendingMatchId}`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async acceptPendingMatch(
    ...
    await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/pending-matches/${pendingMatchId}/accept`,
      method: 'POST',
      headers: {},
    });
  }

  async declinePendingMatch(
    orgId: string,
    leagueId: string,
    pendingMatchId: string
  ): Promise<void> {
    await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/pending-matches/${pendingMatchId}/decline`,
      method: 'POST',
      headers: {},
    });
  }
...
export class V3ActiveMatchesApi extends runtime.BaseAPI {
  async listActiveMatches(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/active-matches`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async cancelActiveMatch(
    orgId: string,
    leagueId: string,
    activeMatchId: string
  ): Promise<void> {
    await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/active-matches/${activeMatchId}`,
      method: 'DELETE',
      headers: {},
    });
  }
  ...
  async submitResult(
    ...
    leagueId: string,
    activeMatchId: string,
    request: SubmitActiveMatchResultRequest
  ): Promise<MatchResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/active-matches/${activeMatchId}/submit`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
...
export class V3MatchFlagsApi extends runtime.BaseAPI {
  async createFlag(
    orgId: string,
    leagueId: string,
    request: CreateMatchFlagRequest
  ): Promise<MatchFlagResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/match-flags`,
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
  ...
  async getMyFlags(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/match-flags/me`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async updateFlagReason(
    ...
    leagueId: string,
    flagId: string,
    request: UpdateMatchFlagReasonRequest
  ): Promise<MatchFlagResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/match-flags/${flagId}`,
      method: 'PUT',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
...
export class V3AdminMatchFlagsApi extends runtime.BaseAPI {
  async listAllFlags(
    ...
    if (status) query['status'] = status;
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/admin/match-flags`,
      method: 'GET',
      headers: {},
      query,
    });
  ...
  async getFlag(
    ...
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/admin/match-flags/${flagId}`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async resolveFlag(
    ...
    leagueId: string,
    flagId: string,
    request: ResolveMatchFlagRequest
  ): Promise<MatchFlagResponse> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/admin/match-flags/${flagId}/resolve`,
      method: 'PATCH',
      headers: { 'Content-Type': 'application/json' },
      body: request,
    });
...
export class OrganizationInviteLinksApi extends runtime.BaseAPI {
  async listInviteLinks(orgId: string): Promise<InviteLinkResponse[]> {
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/invite-links`,
      method: 'GET',
      headers: {},
    });
    return await response.json();
  ...
  async deleteInviteLink(orgId: string, linkId: string): Promise<void> {
    await this.request({
      path: `/api/v3/organizations/${orgId}/invite-links/${linkId}`,
      method: 'DELETE',
      headers: {},
    });
  }
...
export class V3StatisticsApi extends runtime.BaseAPI {
  async getTimeDistribution(
    ...
    if (seasonId) query['seasonId'] = seasonId;
    const response = await this.request({
      path: `/api/v3/organizations/${orgId}/leagues/${leagueId}/statistics/time-distribution`,
      method: 'GET',
      headers: {},
      query,
    });

...
export type PendingMatchStatus =
  (typeof PendingMatchStatus)[keyof typeof PendingMatchStatus];
...
export function PendingMatchStatusFromJSONTyped(
  json: any,
...
export function PendingMatchStatusToJSON(
  value?: PendingMatchStatus | null
): any {
  return value as any;
}

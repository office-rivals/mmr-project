...
export function PersonalAccessTokenResponseFromJSON(
  json: any
): PersonalAccessTokenResponse {
  return PersonalAccessTokenResponseFromJSONTyped(json, false);
}

export function PersonalAccessTokenResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    name: json['name'],
    lastUsedAt:
      json['lastUsedAt'] == null ? undefined : new Date(json['lastUsedAt']),
    expiresAt:
...
export function PersonalAccessTokenResponseToJSON(
  value?: PersonalAccessTokenResponse | null
): any {
  if (value == null) {
    return value;
  }

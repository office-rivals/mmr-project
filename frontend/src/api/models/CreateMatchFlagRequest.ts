...
export function CreateMatchFlagRequestFromJSON(
  json: any
): CreateMatchFlagRequest {
  return CreateMatchFlagRequestFromJSONTyped(json, false);
}

export function CreateMatchFlagRequestFromJSONTyped(
  json: any,
...
export function CreateMatchFlagRequestToJSON(
  value?: CreateMatchFlagRequest | null
): any {
  if (value == null) {
    return value;
  }

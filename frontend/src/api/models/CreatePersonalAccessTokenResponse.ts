 ...
 */
export function instanceOfCreatePersonalAccessTokenResponse(
  value: object
): boolean {
...
export function CreatePersonalAccessTokenResponseFromJSON(
  json: any
): CreatePersonalAccessTokenResponse {
  return CreatePersonalAccessTokenResponseFromJSONTyped(json, false);
}

export function CreatePersonalAccessTokenResponseFromJSONTyped(
  json: any,
...
export function CreatePersonalAccessTokenResponseToJSON(
  value?: CreatePersonalAccessTokenResponse | null
): any {
  if (value == null) {
    return value;
  }

...
export function MatchMakingQueueStatusFromJSON(
  json: any
): MatchMakingQueueStatus {
  return MatchMakingQueueStatusFromJSONTyped(json, false);
}

export function MatchMakingQueueStatusFromJSONTyped(
  json: any,
  ...
  return {
    ...
    assignedPendingMatch:
      json['assignedPendingMatch'] == null
        ? undefined
        : MatchMakingQueueStatusPendingMatchFromJSON(
            json['assignedPendingMatch']
          ),
    assignedActiveMatch:
      json['assignedActiveMatch'] == null
        ? undefined
        : ActiveMatchDtoFromJSON(json['assignedActiveMatch']),
  };
}

export function MatchMakingQueueStatusToJSON(
  value?: MatchMakingQueueStatus | null
): any {
  if (value == null) {
    return value;
  }
  return {
    ...
    assignedPendingMatch: MatchMakingQueueStatusPendingMatchToJSON(
      value['assignedPendingMatch']
    ),

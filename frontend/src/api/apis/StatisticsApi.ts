...
export class StatisticsApi extends runtime.BaseAPI {
  ...
  async statisticsGetLeaderboardRaw(
    requestParameters: StatisticsGetLeaderboardRequest,
  ...
  async statisticsGetLeaderboard(
    ...
    const response = await this.statisticsGetLeaderboardRaw(
      requestParameters,
      initOverrides
    );
  ...
  async statisticsGetTimeDistributionRaw(
    requestParameters: StatisticsGetTimeDistributionRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ...
  async statisticsGetTimeDistribution(
    ...
    const response = await this.statisticsGetTimeDistributionRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();

...
import type { ClaimProfileRequest, ProfileDetails } from '../models/index';
import {
...
export class ProfileApi extends runtime.BaseAPI {
  /**
   */
  async profileClaimProfileRaw(
    requestParameters: ProfileClaimProfileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<ProfileDetails>> {
    ...
    const response = await this.request(
      {
        ...
        body: ClaimProfileRequestToJSON(
          requestParameters['claimProfileRequest']
        ),
      },
      initOverrides
    );
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      ProfileDetailsFromJSON(jsonValue)
    );
  }

  /**
   */
  async profileClaimProfile(
    requestParameters: ProfileClaimProfileRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<ProfileDetails> {
    const response = await this.profileClaimProfileRaw(
      requestParameters,
      initOverrides
    );

...
import type { CreateUserRequest, UserDetails } from '../models/index';
import {
...
export class UsersApi extends runtime.BaseAPI {
  /**
   */
  async usersCreateUserRaw(
    requestParameters: UsersCreateUserRequest,
  ...
  /**
   */
  async usersCreateUser(
    requestParameters: UsersCreateUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<UserDetails> {
    const response = await this.usersCreateUserRaw(
      requestParameters,
      initOverrides
    );
  ...
  /**
   */
  async usersGetUserRaw(
    requestParameters: UsersGetUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<UserDetails>> {
    ...
    const response = await this.request(
      {
        path: `/api/v1/users/{userId}`.replace(
          `{${'userId'}}`,
  ...
  async usersGetUser(
    ...
    const response = await this.usersGetUserRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();
  ...
  /**
   */
  async usersSearchUserRaw(
    requestParameters: UsersSearchUserRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<UserDetails>>> {
    const queryParameters: any = {};
  ...
  async usersSearchUser(
    ...
    const response = await this.usersSearchUserRaw(
      requestParameters,
      initOverrides
    );
    return await response.value();

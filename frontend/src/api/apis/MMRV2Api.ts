...
import type { MatchDetailsV2, SubmitMatchV2Request } from '../models/index';
import {
...
export class MMRV2Api extends runtime.BaseAPI {
  /**
   */
  async mMRV2GetMatchesRaw(
    requestParameters: MMRV2GetMatchesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<MatchDetailsV2>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(MatchDetailsV2FromJSON)
    );
  }

  /**
   */
  async mMRV2GetMatches(
    requestParameters: MMRV2GetMatchesRequest = {},
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<MatchDetailsV2>> {
    const response = await this.mMRV2GetMatchesRaw(
      requestParameters,
      initOverrides
    );
  ...
  /**
   */
  async mMRV2SubmitMatchRaw(
    requestParameters: MMRV2SubmitMatchRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: SubmitMatchV2RequestToJSON(
          requestParameters['submitMatchV2Request']
        ),
      },
      initOverrides
    );

import type { ButtonRootPropsWithoutHTML, WithoutChildren } from 'bits-ui';
import type {
...
// type DistributiveIntersection<T, U> = T extends unknown ? T & U : never;
...
export {
  ...
  Root,
  buttonVariants,
  type ButtonElement as ButtonOnlyProps,
